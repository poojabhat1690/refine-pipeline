...
intronAnnotation[is.na(intronAnnotation)] <- ""
exonAnnotation[is.na(exonAnnotation)] <- ""
...
### peaks_bedFile = read.table("/clustertmp/pooja/polyAmapping_allTimepoints/n_100_global_a0/sequences_120nts.bed.gz",sep="\t",stringsAsFactors = F)

peaks_bedFile = read.table(paste0(InPath, "/sequences_120nts.bed.gz"),sep="\t",stringsAsFactors = F) ### this is temp .gz!
